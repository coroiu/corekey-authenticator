...
export type EmitFunction = DomainEventEmitter["extractAndEmit"];

export abstract class DomainEventEmitter<OutType = DomainEvent> {
  private counter = 0;
  ...
  protected extractAndEmit(entity_event: Entity | Event) {
